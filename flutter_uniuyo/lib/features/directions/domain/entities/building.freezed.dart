...
mixin _$Building {
  ...
  double get areaM2 => throw _privateConstructorUsedError;
  String get buildingFunction => throw _privateConstructorUsedError;
...
class _$BuildingCopyWithImpl<$Res, $Val extends Building>
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      areaM2: null == areaM2
          ? _value.areaM2
          : areaM2 // ignore: cast_nullable_to_non_nullable
              as double,
      buildingFunction: null == buildingFunction
          ? _value.buildingFunction
          : buildingFunction // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$BuildingImpl implements _Building {
  const _$BuildingImpl(
      ...
      required this.buildingFunction,
  ...
  @override
  String toString() {
    return 'Building(gid: $gid, name: $name, areaM2: $areaM2, buildingFunction: $buildingFunction, coordinates: $coordinates)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.areaM2, areaM2) || other.areaM2 == areaM2) &&
            (identical(other.buildingFunction, buildingFunction) ||
                other.buildingFunction == buildingFunction) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, gid, name, areaM2,
      buildingFunction, const DeepCollectionEquality().hash(_coordinates));
...
abstract class _Building implements Building {
  const factory _Building(
      ...
      required final String buildingFunction,
      required final List<List<List<double>>> coordinates}) = _$BuildingImpl;
